      ...
      <section id="work">
        <div id="workcontent">
          ...
          <a href="work/sproutandkernel.php">
            <img src="assets/thumbnails/sproutandkernel.png" alt="">
            <div class="overlay">
              <h2>sprout & kernel</h2>
            </div>
          </a>
          <a href="work/bookcovers.php">
            <img src="assets/thumbnails/neal.png" alt="">
            <div class="overlay">
              <h2>Book Covers</h2>
            </div>
          </a>
          ...
          <a href="work/ithilien.php">
            <img src="assets/thumbnails/ithilien.png" alt="">
            <div class="overlay">
              <h2>ithilien</h2>
            </div>
          </a>
          ...
          <!-- <a href="work/notadiner.php">
            <img src="assets/thumbnails/notadiner.png" alt="">
            <div class="overlay">
              <h2>Not a Diner</h2>
            </div>
          </a> -->
