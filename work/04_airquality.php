    ...
    <body>
		...
		<section id="project">
            <div id="projectcontent">
    			<h2 class="projectTitle">AIR QUALITY</h2>
    			<p>A drawing tool that uses real <a href="https://en.wikipedia.org/wiki/Air_quality_index">AQI (Air Quality Index)</a> data from a chosen list of cities to control the brush; the more polluted the air, the darker and broader the brush. There is no way to clear the drawing (other than using the least polluted city's brush as an eraser of sorts)&mdash;an obvious enough metaphor.</p>
    			<p>Uses the <a href="http://aqicn.org/here/">aqicn.org</a> API.</p>
    			<p><a href="airquality/">Give it a go yourself.</a></p>
    			<div class="img-group">
                    <img class="big space_top" src="images/airquality.jpg">     
                </div>
    			<!-- <img class="big last" src="images/aqi_2.png"> -->
    		</div>
        </section>
    	<menu>
