    ...
    <body>
        ...
        <section id="project">
            <div id="projectcontent">
                <h2 class="projectTitle">The Patrón Experience</h2>
                <h3>Midnight Commercial</h3>
                <p>Role: Concepting, UX/UI.</p>
                <p>In collaboration with <a href="http://mbooth.com/">M Booth</a>, <a href="http://midnightcommercial.com/">Midnight Commercial</a> created an augmented reality application for Patrón using Apple's freshly released ARKit. The application brings the Patrón Hacienda to the user's tabletop, complete with agave field and jimadors, 4 virtual bottles of Patrón tequila and an animated bartender to talk the user through the tasting notes of each expression.</p>
                <p>I lead the creation of images for the pitch, and was later responsible for the user experience and design from onboarding to the AR enhanced image capture feature.</p>
                <div class="img-group">
                    <img class="big" src="images/patron_age-gate.png">
                    <img class="big" src="images/patron_bartender.jpg">
                    <img class="big" src="images/patron_frame.jpg">
                    <img class="big" src="images/patron_extra-anejo.jpg">
                </div>
                <p>For additional information and press, check out <a href="http://midnightcommercial.com/project/the-patron-experience/" target="_blank">Midnight Commercial's documentation</a>.</p>
            </div>
        </section>
        <menu>
