...
<html>
    ...
    <body>
        ...
        <section id="project">
            <div id="projectcontent">
               <h2 class="projectTitle">FLANDILL</h2>
                ...
                <p>Once a beautiful and peaceful place, humans have since discovered the planet, depleting its resources and polluting its air. The creatures that live there, "deebs," are an endangered species. If during your visit to the site you kill one of these deebs, that deeb is dead, forever&mdash;R.I.P. Phil. All of our actions have effects, however insignificant they may seem, so just by visiting Flandill&mdash;whether or not you pick the flowers or scare the deebs&mdash;you add pollutants to Flandill's ecosystem. As these pollutants add up, the health of the planet deteriorates, visibly. If the <a href="http://www.theguardian.com/environment/planet-oz/2016/may/20/carbon-dioxides-400ppm-milestone-shows-humans-are-re-writing-the-planets-history">atmospheric pollution breaches 400ppm</a>, Flandill will be forever transformed, and the deebs face extinction. Every day the planet goes without a visit, its air clears slightly.</p>
                <div class="img-group">
        ...
        <menu>
            ...
            <a href="02_bindthisbook.php" class="nav">
