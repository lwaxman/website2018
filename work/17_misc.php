    ...
    <body>
        ...
        <section id="project">
            <div id="projectcontent">
                <h2 class="projectTitle">Misc.</h2> 
                <p>An assortment of some other things I've made.</p>
                <div class="img-group">
                    <img class="big" src="images/trees_1.jpg">
                    <img class="big" src="images/trees_2.jpg">
                    <img class="big" src="images/portrait_of_a_bar.png">
                    <img class="big" src="images/illustration-01.gif">
                    <img class="small" src="images/card_01.jpg"><img class="small" src="images/card_02.jpg">
                    <img class="big" src="images/card_03.JPG">
                    <img class="big" src="images/card_04.JPG">
                    <img class="big" src="images/paper_tryouts.jpg">
                    <img class="big" src="images/paper_alphabet.jpg">
                    <img class="big" src="images/city1.jpg">
                    <img class="small" src="images/city2.jpg"><img class="small" src="images/city3.jpg">
                    <img class="big" src="images/city4.jpg">
                    <img class="big" src="images/city5.jpg">
                </div>
            </div>
        </section>
        <menu>
