    ...
    <body>
        ...
        <section id="project">
            <div id="projectcontent">
                <h2 class="projectTitle">sol-3: trash cityscape</h2>
                <blockquote>Sol-3 is only eight thousand miles in diameter, which is almost a negligible dimension in the great vastness of space. It was so extraordinarily well invented and designed that to the best of our knowledge its residents have been on board it for two million years not even knowing that they were on board a ship. But these residents of Sol-3 are not going to be able to operate their spaceship successfully nor for much longer unless they come to see it as a whole spaceship and their fate as common. It has to be everybody or nobody. <br><br> —adapted from Buckminster Fuller, &ldquo;Operating Manual for Spaceship Earth&rdquo;</blockquote>
                <p>Sol-3 is an accordion fold art-book of one continuous illustration. It was illustrated in felt-tip marker and later printed duotone on a risograph printer. Each page is 8.5x14" and illustrated at a one-to-one ratio. When open flat, it measures 8.5x126".</p>
                <div class="img-group">
                    <img class="big" src="images/microhabitats0.jpg">
                    <img class="big" src="images/microhabitats1.jpg">
                    <img class="big" src="images/microhabitats2.jpg">
                    <img class="big" src="images/microhabitats3.jpg">
                    <img class="big" src="images/microhabitats4.jpg">
                    <img class="big" src="images/microhabitats5.jpg">
                    <img class="big" src="images/microhabitats6.jpg">
                    <img class="big" src="images/microhabitats7.jpg">
                    <img class="big" src="images/microhabitats8.jpg">
                    <img class="big" src="images/microhabitats9.jpg">
                </div>
            </div>
        </section>
        <menu>
            <?php include '../menuProject.php'; ?>
            <a href="09_ardent.php" class="nav">
            ...
            <a href="12_tealights.php" class="nav">
