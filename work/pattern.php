    ...
    <body>
        ...
        <section id="project">
            <div id="projectcontent">
                <h2 class="projectTitle">PATTERN</h2>
                <p>Once upon a time, the background of t
                It allowed any visitor to create a new pattern, and would save so the next visitor would see what the previous visitor had left.</p>
                <div class="img-group">
